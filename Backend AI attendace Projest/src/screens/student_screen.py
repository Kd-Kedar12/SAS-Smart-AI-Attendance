...
import numpy as np
from src.pipeline.face_pipeline import get_face_embeddings, predict_attendance, train_classifier
...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input("Enter your name", placeholder='E.g. Kedarnath Mohanty')
